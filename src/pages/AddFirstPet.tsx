...
const AddFirstPet = ({ navigation }: AddFirstPetScreenProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Set as active pet
        ...
        // Mark user onboarding as complete (unique to AddFirstPet)
        ...
        [
          {
            text: 'OK',
              onPress: () => {
                // We don't need to navigate since AppNavigator will handle this automatically
            ...
            [
              {
                text: 'OK',
                onPress: () => {
                  // We don't need to navigate here either
                  console.log("Pet added locally - returning to home");
                }
              }
            ]
          );
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>Add Your First Pet</Text>
